...
public abstract class HISurfaceViewBase extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public HISurfaceViewBase(Context context, AttributeSet attrs){
    	super(context, attrs);
    	setHolder();
    }
